...
{
    public class ReportCustomerSalesOrderByItem_OrganizationDTO : DataDTO
    {
        ...
        public ReportCustomerSalesOrderByItem_OrganizationDTO() { }
        public ReportCustomerSalesOrderByItem_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportCustomerSalesOrderByEmployeeAndItem_OrganizationFilterDTO : FilterDTO
    {
