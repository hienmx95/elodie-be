...
namespace ELODIE.Rpc.organization
{
    public class OrganizationController : RpcController
    {
        ...
        [Route(OrganizationRoute.ListAppUser), HttpPost]
        public async Task<List<Organization_AppUserDTO>> ListAppUser([FromBody] Organization_AppUserFilterDTO Organization_AppUserFilterDTO)
        {
            AppUserFilter AppUserFilter = new AppUserFilter();
            AppUserFilter.Skip = Organization_AppUserFilterDTO.Skip;
            AppUserFilter.Take = Organization_AppUserFilterDTO.Take;
            AppUserFilter.OrderBy = Organization_AppUserFilterDTO.OrderBy;
            AppUserFilter.OrderType = Organization_AppUserFilterDTO.OrderType;
            AppUserFilter.Selects = AppUserSelect.ALL;
            AppUserFilter.Id = Organization_AppUserFilterDTO.Id;
            AppUserFilter.Username = Organization_AppUserFilterDTO.Username;
            AppUserFilter.Password = Organization_AppUserFilterDTO.Password;
            ...
            AppUserFilter.OrganizationId = Organization_AppUserFilterDTO.OrganizationId;
            AppUserFilter.SexId = Organization_AppUserFilterDTO.SexId;
            AppUserFilter.StatusId = Organization_AppUserFilterDTO.StatusId;
            AppUserFilter.OrganizationTreeFilterType = Organization_AppUserFilterDTO.OrganizationTreeFilterType;
        ...
        [Route(OrganizationRoute.CountAppUser), HttpPost]
        public async Task<int> CountAppUser([FromBody] Organization_AppUserFilterDTO Organization_AppUserFilterDTO)
        {
            AppUserFilter AppUserFilter = new AppUserFilter();
            AppUserFilter.Skip = Organization_AppUserFilterDTO.Skip;
            AppUserFilter.Take = Organization_AppUserFilterDTO.Take;
            ...
            int result = await AppUserService.Count(AppUserFilter);
            return result;
        }

        [Route(OrganizationRoute.SingleListTreeSelectOption), HttpPost]
        public async Task<List<Organization_StatusDTO>> SingleListTreeSelectOption()
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            List<Organization_StatusDTO> Organization_StatusDTOs = TreeSelectOptionEnum.TreeSelectOptionEnumList.Select(x => new Organization_StatusDTO
            {
                Id = x.Id,
                Code = x.Code,
                Name = x.Name,
