...
namespace ELODIE.Rpc.supplier
{
    public partial class SupplierController : RpcController
    {
        ...
        [Route(SupplierRoute.SingleListNation), HttpPost]
        public async Task<List<Supplier_NationDTO>> SingleListNation([FromBody] Supplier_NationFilterDTO Supplier_NationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(SupplierRoute.SingleListAppUser), HttpPost]
        ...
        [Route(SupplierRoute.SingleListCategory), HttpPost]
        public async Task<List<Supplier_CategoryDTO>> SingleListCategory([FromBody] Supplier_CategoryFilterDTO Supplier_CategoryFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
