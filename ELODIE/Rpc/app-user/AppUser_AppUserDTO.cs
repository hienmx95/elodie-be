...
namespace ELODIE.Rpc.app_user
{
    public class AppUser_AppUserDTO : DataDTO
    {
        ...
        public List<AppUser_AppUserSiteMappingDTO> AppUserSiteMappings { get; set; }
        ...
        public AppUser_AppUserDTO(AppUser AppUser)
        {
            ...
            this.AppUserSiteMappings = AppUser.AppUserSiteMappings?.Select(x => new AppUser_AppUserSiteMappingDTO(x)).ToList();
