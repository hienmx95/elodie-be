...
{
    public class CodeGeneratorRule_EntityTypeDTO : DataDTO
    {
        ...
        public CodeGeneratorRule_EntityTypeDTO() {}
        public CodeGeneratorRule_EntityTypeDTO(EntityType EntityType)
        {
