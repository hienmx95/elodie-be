...
{
    public class CodeGeneratorRule_EntityComponentDTO : DataDTO
    {
        ...
        public CodeGeneratorRule_EntityComponentDTO() {}
        public CodeGeneratorRule_EntityComponentDTO(EntityComponent EntityComponent)
        {
