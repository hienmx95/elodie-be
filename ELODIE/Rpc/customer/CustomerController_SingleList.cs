...
namespace ELODIE.Rpc.customer
{
    public partial class CustomerController : RpcController
    {
        ...
        public async Task<List<Customer_SexDTO>> SingleListSex([FromBody] Customer_SexFilterDTO Customer_SexFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<Customer_StatusDTO>> SingleListStatus([FromBody] Customer_StatusFilterDTO Customer_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
