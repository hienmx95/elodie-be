...
namespace ELODIE.Rpc.customer
{
    public partial class CustomerController : RpcController
    {
        ...
        public async Task<List<Customer_AppUserDTO>> FilterListAppUser([FromBody] Customer_AppUserFilterDTO Customer_AppUserFilterDTO)
        {
        ...
        [Route(CustomerRoute.FilterListCodeGeneratorRule), HttpPost]
        public async Task<List<Customer_CodeGeneratorRuleDTO>> FilterListCodeGeneratorRule([FromBody] Customer_CodeGeneratorRuleFilterDTO Customer_CodeGeneratorRuleFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(CustomerRoute.FilterListCustomerSource), HttpPost]
        public async Task<List<Customer_CustomerSourceDTO>> FilterListCustomerSource([FromBody] Customer_CustomerSourceFilterDTO Customer_CustomerSourceFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<Customer_DistrictDTO>> FilterListDistrict([FromBody] Customer_DistrictFilterDTO Customer_DistrictFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<Customer_NationDTO>> FilterListNation([FromBody] Customer_NationFilterDTO Customer_NationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(CustomerRoute.FilterListOrganization), HttpPost]
        public async Task<List<Customer_OrganizationDTO>> FilterListOrganization([FromBody] Customer_OrganizationFilterDTO Customer_OrganizationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<Customer_ProfessionDTO>> FilterListProfession([FromBody] Customer_ProfessionFilterDTO Customer_ProfessionFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        public async Task<List<Customer_ProvinceDTO>> FilterListProvince([FromBody] Customer_ProvinceFilterDTO Customer_ProvinceFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
