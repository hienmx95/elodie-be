...
{
    public class DashboardOrder_OrganizationDTO : DataDTO
    {
        ...
        public DashboardOrder_OrganizationDTO() { }
        public DashboardOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class DashboardOrder_OrganizationFilterDTO : FilterDTO
    {
