...
namespace ELODIE.Enums
{
    public class RoutingKeyEnum
    {
        ...
        public static GenericEnum BrandSync = new GenericEnum { Id = 2, Code = "Brand.Sync", Name = "Đồng bộ Brand" };
        ...
        public static GenericEnum RoleUsed = new GenericEnum { Id = 1012, Code = "ELODIE.Role.Used", Name = "Role Used" };
        ...
        public static GenericEnum WorkflowDefinitionUsed = new GenericEnum { Id = 1021, Code = "ELODIE.WorkflowDefinition.Used", Name = "WorkflowDefinition Used" };
