...
namespace ELODIE.Services.MUnitOfMeasureGrouping
{
    ...
    public class UnitOfMeasureGroupingValidator : IUnitOfMeasureGroupingValidator
    {
        public enum ErrorCode
        {
            ...
            FactorWrongValue,
            UnitOfMeasureGroupingContentEmpty,
        }
        ...
        {
            if(UnitOfMeasureGrouping.UnitOfMeasureGroupingContents?.Any() != true)
            {
                return true;
            }
        ...
        public async Task<bool> Create(UnitOfMeasureGrouping UnitOfMeasureGrouping)
        {
            ...
            await ValidateUnitOfMeasureGroupingContent(UnitOfMeasureGrouping);
            return UnitOfMeasureGrouping.IsValidated;
        }
        ...
        public async Task<bool> BulkDelete(List<UnitOfMeasureGrouping> UnitOfMeasureGroupings)
        {
            ...
            return UnitOfMeasureGroupings.All(st => st.IsValidated);
        }
